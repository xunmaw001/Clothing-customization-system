<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="服装类型" prop="fuzhuangleixing">
          <el-select :disabled="ro.fuzhuangleixing" v-model="ruleForm.fuzhuangleixing" placeholder="请选择服装类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="服装类型" prop="fuzhuangleixing">
	      <el-input v-model="ruleForm.fuzhuangleixing"
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="样品介绍" prop="yangpinjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yangpinjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yangpinjieshao" label="样品介绍" prop="yangpinjieshao">
                    <span v-html="ruleForm.yangpinjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuzhuangmingcheng = true;
          ...
          if(o=='fuzhuangleixing'){
            this.ruleForm.fuzhuangleixing = obj[o];
	    this.ro.fuzhuangleixing = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.dingzhijiage = true;
          ...
          if(o=='yangpinjieshao'){
            this.ruleForm.yangpinjieshao = obj[o];
	    this.ro.yangpinjieshao = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.yangpinjieshao = this.ruleForm.yangpinjieshao.replace(reg,'../../../ssmegfm3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fuzhuangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fuzhuangxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
